...
abstract class AW_Blog_Block_Abstract extends Mage_Core_Block_Template
{
    ...
    protected static $_postUriParam = AW_Blog_Helper_Data::CATEGORY_URI_PARAM;
    ...
    {      
        return "<a class='aw-blog-read-more' href='{$this->getBlogUrl($item->getIdentifier())}'>{$this->__('Read More')}</a>";
    }
