...
class Tamarashorin_Commercebug_AjaxController extends Mage_Core_Controller_Front_Action
{
    ...
    public function togglehintsAction()
    {
        ...
        $c = $cache->load(Tamarashorin_Commercebug_Model_Observer::TEMPLATE_HINTS_ON);
        $c = $c == 'on' ? 'off' : 'on';        
        $cache->save($c, Tamarashorin_Commercebug_Model_Observer::TEMPLATE_HINTS_ON, array(Mage_Core_Model_Config::CACHE_TAG), (60 * 60 * 24 * 1));
    ...
    {
        $cache = $this->_getCacheObject();
        $c = $cache->load(Tamarashorin_Commercebug_Model_Observer::BLOCK_HINTS_ON);
        $c = $c == 'on' ? 'off' : 'on';        
        $cache->save($c, Tamarashorin_Commercebug_Model_Observer::BLOCK_HINTS_ON, array(Mage_Core_Model_Config::CACHE_TAG), (60 * 60 * 24 * 1));
    ...
    {
        $cache = $this->_getCacheObject();
        $c = $cache->load(Tamarashorin_Commercebug_Model_Observer::MAGE_LOGGING_ON);
        $c = $c == 'on' ? 'off' : 'on';        
        $cache->save($c, Tamarashorin_Commercebug_Model_Observer::MAGE_LOGGING_ON, array(Mage_Core_Model_Config::CACHE_TAG), (60 * 60 * 24 * 1));
    ...
    {
        $cache = $this->_getCacheObject();
        $c = $cache->load(Tamarashorin_Commercebug_Model_Observer::CB_LOGGING_ON);
        $c = $c == 'on' ? 'off' : 'on';        
        $cache->save($c, Tamarashorin_Commercebug_Model_Observer::CB_LOGGING_ON, array(Mage_Core_Model_Config::CACHE_TAG), (60 * 60 * 24 * 1));
