...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Tamarashorin_Commercebug><active>true</active><codePool>local</codePool></Tamarashorin_Commercebug></modules></config>';
        $string = str_replace('Tamarashorin_', $this->namespace . '_',$string);
