...
*/
class Tamarashorin_Commercebug_Model_Collectorblocksandlayout extends Tamarashorin_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Tamarashorin_Commercebug') === 0)
            {
                continue;
            }
