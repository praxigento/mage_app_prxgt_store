...
class Tamarashorin_Commercebug_Block_Html extends Mage_Core_Block_Template
{	
    ...
    {
        $paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Tamarashorin_Commercebug'));
        $valid			= false;
