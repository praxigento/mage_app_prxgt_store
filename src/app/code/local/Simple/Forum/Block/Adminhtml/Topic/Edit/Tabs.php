...
class Simple_Forum_Block_Adminhtml_Topic_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('form_section_icons', array(
            'label'     => Mage::helper('forum/topic')->__('Topic Icons'),
            'title'     => Mage::helper('forum/topic')->__('Topic Icons'),
            'content'   => $this->getLayout()->createBlock('forum/adminhtml_topic_edit_tab_icons')->toHtml(),
        ));
