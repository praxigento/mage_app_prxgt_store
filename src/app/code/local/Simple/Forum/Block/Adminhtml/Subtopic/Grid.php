...
class Simple_Forum_Block_Adminhtml_Subtopic_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('forumSubTopicGrid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('parent_title', array(
            'header'    => Mage::helper('forum/topic')->__('Parent Topic'),
            'align'     => 'left',
            'width'     => '140px',
            'index'     => 'parent_title',
