 ...
 */
class Varien_Data_Form_Element_Multiupload extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        ...
        $actionUrl = Mage::helper('adminhtml')->getUrl('*/*/upload', array('store' => Mage::registry('store_id', 0)));;
